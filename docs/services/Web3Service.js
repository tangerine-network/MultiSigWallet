  ...
  function () {
    angular
      ...
      .service("Web3Service", function ($window, Utils, $uibModal, Connection, Config, $http) {
        ...
        */
        factory.enableTangerine = function (callback) {
          $window.tangerine.enable().then(function (accounts) {
